...
| [`target-allowlists/`](target-allowlists/) | Misma allowlist que `opa/`, en datos | Real — [`target_allowlists.py`](target_allowlists.py) la carga por defecto en `mcp_gateway.Gateway()` |
